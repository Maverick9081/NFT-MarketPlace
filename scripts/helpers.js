...
function getContractMarketPlace(contractName, hre) {
    const account = getAccount();
    return getContractAt(hre,contractName,getEnvVariable("MARKET-PLACE_CONTRACT_ADDRESS"), account);
}

function getContractToken(contractName, hre) {
    const account = getAccount();
    return getContractAt(hre,contractName,getEnvVariable("TOKEN_ADDRESS"), account);
}

function getContractNFT(contractName, hre) {
    const account = getAccount();
